...
// fetch("../../components/emailmarkatingheader/emailmarkatingheader.html")
//     .then((response) => response.text())
//     .then((html) => {
//         loadContactUs(html, "emailmarkating-header");
//     })
//     .catch((error) => {
//         console.error("Error loading HTML:", error);
//     });

// fetch("../../components/emailmarkatingvisually/emailmarkatingvisually.html")
//     .then((response) => response.text())
//     .then((html) => {
//         loadContactUs(html, "emailmarkating-visually");
//     })
//     .catch((error) => {
//         console.error("Error loading HTML:", error);
//     });
...
// fetch("../../components/emailmarkatingpowerfulltool/emailmarkatingpowerfulltool.html")
//     .then((response) => response.text())
//     .then((html) => {
//         loadContactUs(html, "emailmarkating-powerfulltool");
//     })
//     .catch((error) => {
//         console.error("Error loading HTML:", error);
//     });
